...
export default function TestimonialCarousel({ testimonials }: TestimonialCarouselProps) {
  ...
  return (
    <div ref={carouselRef} className="relative overflow-hidden bg-[#09232F]/50 backdrop-blur-sm border border-white/10 rounded-xl p-8">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="md:w-1/3">
                <div className="relative">
                  <div className="w-24 h-24 md:w-32 md:h-32 rounded-full overflow-hidden border-2 border-[#FEA35D]">
                    <img 
