...
function RadioGroupItem({
  ...
  return (
    ...
    >
      ...
      >
        <CircleIcon className="fill-theme-primary absolute top-1/2 left-1/2 size-2 -translate-x-1/2 -translate-y-1/2 transition-colors duration-[var(--theme-transition-normal)]" />
      </RadioGroupPrimitive.Indicator>
    </RadioGroupPrimitive.Item>
  )
}
