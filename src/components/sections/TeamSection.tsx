...
// Team section with cropped sections - content stays in place, window expands
const TeamSection = () => {
  ...
  const teamData = [
    {
      ...
      themeGradient: "bg-[var(--theme-team-joden)]",
    ...
    },
    {
      ...
      themeGradient: "bg-[var(--theme-team-alex)]",
    ...
    },
    {
      ...
      themeGradient: "bg-[var(--theme-team-tia)]",
    ...
    },
    {
      ...
      themeGradient: "bg-[var(--theme-team-aydan)]",
    ...
    <div ref={sectionRef} className="team-section bg-theme-bg-primary">
          ...
          {teamData.map((member, index) => (
            ...
            >
              ...
              <div className="relative w-full h-full">
                {/* Background elements */}
                <div className="absolute top-[10%] left-[15%] w-36 h-36 rounded-[40%] opacity-[var(--theme-float-opacity)] bg-theme-float-bg-primary rotate-12 animate-float-slow"></div>
                <div className="absolute bottom-[15%] right-[10%] w-48 h-48 rounded-[40%] opacity-[var(--theme-float-opacity-secondary)] bg-theme-float-bg-secondary rotate-[-8deg] animate-float-medium"></div>
                <div className="absolute top-[60%] right-[20%] w-24 h-24 rounded-[45%] opacity-[var(--theme-float-opacity)] bg-theme-primary rotate-[22deg] animate-float-medium"></div>
                <div className="absolute bottom-[60%] left-[25%] w-16 h-16 rounded-[35%] opacity-[var(--theme-float-opacity-secondary)] bg-theme-accent rotate-[-15deg] animate-float-slow"></div>
      ...
      <div className="md:hidden space-y-8 px-4 pb-16">
        {teamData.map((member, index) => (
          <div 
            key={member.name}
            className={`p-6 rounded-lg shadow-theme-md relative overflow-hidden transition-all duration-500 ease-in-out ${activeMobileIndex !== index ? 'hover-bubbly' : ''}`}
            style={{ 
              background: `var(--theme-team-${member.name.split(' ')[0].toLowerCase()})`,
              transform: activeMobileIndex === index ? 'translateY(-5px) scale(1.02)' : 'translateY(0) scale(1)',
              boxShadow: activeMobileIndex === index ? 
