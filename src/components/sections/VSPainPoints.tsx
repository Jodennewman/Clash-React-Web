...
const VSPainPoints = () => {
  ...
  useGSAP(() => {
    ...
    // But make main heading visible immediately
    gsap.set(".main-heading", { autoAlpha: 1 });
    
    // Set initial state for animated elements
    gsap.set(".pain-heading", { autoAlpha: 0, y: 20 });
    gsap.set(".pain-desc", { autoAlpha: 0, y: 15 });
    ...
    <div ref={sectionRef} className="painPoints relative overflow-visible py-16 md:py-24 bg-theme-secondary z-10">
      ...
      <div className="container-mobile mx-auto relative z-20">
        <div className="text-center max-w-4xl mx-auto">
          <VSHeading size="xl" className="main-heading mb-16 text-white font-bold">
        ...
        <div className="max-w-5xl mx-auto">
          {/* Centered paragraph with special wrapper */}
          <div className="w-full flex justify-center">
            <VSText size="lg" color="text-white" className="pain-desc component-spacing text-center max-w-4xl font-medium">
          ...
          <div className="component-spacing text-center">
            <VSHeading size="xl" className="pain-heading text-white font-bold mb-8">
