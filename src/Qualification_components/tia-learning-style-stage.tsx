...
const TiaLearningStyleStage: React.FC<TiaLearningStyleStageProps> = ({
  options,
  selectedValue,
  onSelect,
  isAnimating,
      ...
      <div className="flex flex-col space-y-4">
        ...
        <div>
          <div className="flex items-center mb-4">
            <h5 className="text-theme-primary font-medium">Select your learning style</h5>
          </div>
...
export default TiaLearningStyleStage;