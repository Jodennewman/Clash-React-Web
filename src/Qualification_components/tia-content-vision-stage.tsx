...
const TiaContentVisionStage: React.FC<TiaContentVisionStageProps> = ({
  options,
  selectedValue,
  onSelect,
  isAnimating,
      ...
      <div className="flex flex-col space-y-4">
        ...
        <div>
          <div className="flex items-center mb-4">
            <h5 className="text-theme-primary font-medium">Select your content vision</h5>
          </div>
        ...
        <div className="p-2">
          <p className="text-theme-primary text-center text-xl md:text-2xl font-medium tracking-wide">
            We'll customize the framework to fit your content ambitions
          </p>
        </div>
      </div>
    </div>
...
export default TiaContentVisionStage;