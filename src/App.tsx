  ...
  return (
    <Router>
      ...
      <div className="fixed bottom-4 right-4 z-50">
        <button 
          data-theme-toggle
          className="flex items-center justify-center w-10 h-10 rounded-full bg-[var(--bg-cream)] dark:bg-[var(--bg-navy)] border border-[var(--text-navy)]/10 dark:border-[var(--text-cream)]/10 shadow-md hover:shadow-lg transition-all duration-300"
          aria-label="Toggle theme"
        >
          <span data-theme-dark className="text-[var(--text-navy)]">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"></path>
            </svg>
          </span>
          <span data-theme-light className="hidden text-[var(--text-cream)]">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="fixed bottom-4 left-4 z-50">
        <Link to="/marble-buttons" className="flex items-center justify-center w-10 h-10 rounded-full bg-[var(--primary-orange)] shadow-lg hover:scale-110 transition-transform">
