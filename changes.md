...
- Line 163: `text-[--hud-accent-red]`
  ...
  - Suggested replacement: `text-[var(--hud-accent-red)]`
...
- Line 63: `bg-[var(--theme-border-primary)]`
  ...
  - Suggested replacement: `bg-[var(--theme-border-primary)]`
...
- Line 135: `bg-[var(--theme-accent-coral)]`
  ...
  - Suggested replacement: `bg-[var(--theme-accent-coral)]`
...
- Line 234: `text-[var(--theme-accent-coral)]`
  ...
  - Suggested replacement: `text-[var(--theme-accent-coral)]`
...
- Line 137: `bg-[--secondary-teal-light]`
  ...
  - Suggested replacement: `text-[#00869A]`
